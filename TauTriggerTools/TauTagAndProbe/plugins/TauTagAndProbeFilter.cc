...
//Harjot        EDGetTokenT<pat::TauRefVector>   _tausTag;
        EDGetTokenT<reco::PFTauRefVector>   _tausTag;
...
//Harjot _tausTag  (consumes<pat::TauRefVector>  (iConfig.getParameter<InputTag>("taus"))),
_tausTag  (consumes<reco::PFTauRefVector>  (iConfig.getParameter<InputTag>("taus"))),
...
{
//Harjot    produces <pat::TauRefVector>  (); // probe
    produces <reco::PFTauRefVector>  (); // probe
...
//Harjot    std::unique_ptr<pat::TauRefVector>  resultTau  ( new pat::TauRefVector  );  
    std::unique_ptr<reco::PFTauRefVector>  resultTau  ( new reco::PFTauRefVector  );
    ...
    // ------------------- get Taus -------------------------------
//Harjot    Handle<pat::TauRefVector> tauHandle;
    Handle<reco::PFTauRefVector> tauHandle;
    ...
    {
//Harjot        const pat::TauRef tau = (*tauHandle)[itau] ;
        const reco::PFTauRef tau = (*tauHandle)[itau] ;
