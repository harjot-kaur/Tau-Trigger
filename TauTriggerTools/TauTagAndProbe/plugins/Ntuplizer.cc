...
//Harjot        int GenIndex(const pat::TauRef& tau, const edm::View<pat::GenericParticle>* genparts);
        int GenIndex(const reco::PFTauRef& tau, const edm::View<pat::GenericParticle>* genparts);
...
//Harjot        edm::EDGetTokenT<pat::TauRefVector>   _tauTag;
...
//Harjot _tauTag         (consumes<pat::TauRefVector>                      (iConfig.getParameter<edm::InputTag>("taus"))),
...
//Harjot    edm::Handle<pat::TauRefVector>  tauHandle;
...
//Harjot    const pat::TauRef tau = (*tauHandle)[0] ;
    const reco::PFTauRef tau = (*tauHandle)[0] ;
...
//Harjot int Ntuplizer::GenIndex(const pat::TauRef& tau, const edm::View<pat::GenericParticle>* genparts){
 int Ntuplizer::GenIndex(const reco::PFTauRef& tau, const edm::View<pat::GenericParticle>* genparts){
